...
import routes.auto_gempa_route
import routes.gempa_terkini_route
...
app.include_router(routes.auto_gempa_route.router)
app.include_router(routes.gempa_terkini_route.router)
...
async def add_process_time_header(request: Request, call_next):
    ...
    logging.basicConfig(filename="./logs/logs_api_incoming_module_"+str(today_date)+".log", level=logging.INFO)
    # logging.info(log)
...
async def hello_world():
    return {"message": "Hello, this is api incoming module backend!"}
