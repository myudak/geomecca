...
def process_data(data):
    try:
        ...
        messages = redis_client.lrange(f'{channel}_history', 0, 3000)
        ...
        if not df.empty:
            ...
            # Iterate over the rows and create Trace objects
...
async def get_data_from_redis():
    ...
    if regional:
        ...
        arr_results = split_array(station_ready_to_get_datas, len(station_ready_to_get_datas))
