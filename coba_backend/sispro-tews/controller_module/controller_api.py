...
import routes.origin_routes
from utils.util import my_random_string

import routes.user_routes
import routes.station_routes
import routes.event_routes
import routes.map_view_routes
import routes.arrival_routes
import routes.cluster_routes
import routes.magnitude_routes
import routes.pick_routes
import routes.config_routes
import routes.origin_routes
import routes.wadati_routes
import routes.arrival_katalog_routes
...
app.include_router(routes.station_routes.router)
app.include_router(routes.event_routes.router)
app.include_router(routes.map_view_routes.router)
app.include_router(routes.arrival_routes.router)
app.include_router(routes.cluster_routes.router)
app.include_router(routes.magnitude_routes.router)
app.include_router(routes.pick_routes.router)
app.include_router(routes.config_routes.router)
app.include_router(routes.origin_routes.router)
app.include_router(routes.wadati_routes.router)
app.include_router(routes.arrival_katalog_routes.router)
...
async def hello_world():
    return {"message": "Hello, this is controller module backend!"}
