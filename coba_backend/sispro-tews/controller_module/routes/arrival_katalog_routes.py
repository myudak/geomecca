...
from services.arrival_katalog_service import get_arrival_katalog_service
...
router = APIRouter(prefix="/api/v1/arrivalkatalog")
...
async def get_plot(
    ...
    response = get_arrival_katalog_service(db, origin_id, current_user)
