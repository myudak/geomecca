...
def get_waveform_data(db,fdsn_urls, network, station, location, channel):
    ...
    day_mseed_filename = f"{network}.{station}.{location}.{channel}.{utc_year}.{utc_julian_day}.mseed"
                ...
                if seconds_difference > 1:
                    ...
                    for fdsn_url in fdsn_urls:
                        ...
                        try:
                            ...
                            day_mseed_filename = network+"."+station+".."+channel+".D."+utc_year+"."+utc_julian_day+".mseed"
                            print(path_save_day+"/"+day_mseed_filename)
