  ...
  <Teleport to="body">
    <div class="fixed inset-0 z-[9999] flex justify-start">
      <button
        ...
        @click="$emit('close')" />
      <div
        class="relative flex h-full w-80 flex-col border-l border-base-200/80 bg-base-100 text-base-content shadow-2xl dark:border-white/5 dark:bg-brand-surface-darker dark:text-white lg:w-96">
