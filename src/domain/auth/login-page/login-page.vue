...
const featureColumns = [
  [
    ...
    'Weather Intelligence & Forecast Dashboards',
  ...
  [
    ...
    'Coastal and Field Operations Readiness',
...
<template>
  <div class="flex min-h-screen flex-col bg-white text-slate-900 lg:flex-row dark:bg-white dark:text-slate-900">
    ...
    <div class="relative hidden overflow-hidden lg:flex lg:w-[58%]">
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-[#2f1f00]/95 via-[#6a4300]/88 to-[#b97b00]/82" />
      ...
      <div class="relative z-10 flex flex-col justify-center px-16 py-16 text-white xl:px-24">
        <div class="mb-10 flex items-center gap-4">
          <div class="flex h-16 w-16 items-center justify-center rounded-full bg-white/10 backdrop-blur">
            <img src="/images/logo-UI.png" alt="MHEWS Logo" class="h-12 w-12 object-contain" />
          </div>
          <div>
            <p class="text-xs uppercase tracking-[0.3em] text-white/70">MHEWS</p>
            <p class="text-xl font-semibold tracking-wide">Multi-Hazard Analytics Platform</p>
          </div>
        </div>

        <div class="mb-10 max-w-2xl">
          <h1 class="text-4xl font-bold leading-tight text-white lg:text-5xl">
            AI-Powered Multi-Hazard Early Warning System
          </h1>
        ...
        <div class="grid gap-8 md:grid-cols-2">
          <div
            ...
            <div v-for="feature in column" :key="feature" class="flex items-start gap-3">
              <div class="mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-amber-300/20">
    ...
    <div class="flex w-full items-center justify-center bg-white px-6 py-16 lg:w-[42%] dark:bg-white">
      <div class="w-full max-w-md space-y-10">
        <div class="space-y-3">
          ...
          <p class="text-sm text-slate-500">Login to access your MHEWS multi-hazard workspace</p>
        </div>
